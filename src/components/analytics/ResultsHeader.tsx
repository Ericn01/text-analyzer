            ...
            <div className="container max-w-[1200px] mx-auto p-5">
                <nav className="flex justify-between items-center">
                    ...
                    <ul className="flex gap-5">
                        ...
                        <li className="text-black/70 md:text-lg py-2 px-4 rounded-lg transition delay-75 duration-300 ease hover:bg-[#667eea] hover:text-white hover:cursor-pointer"> New Analysis</li>
                    </ul>
                </nav>
            </div>
        </header>
